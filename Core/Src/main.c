...
const osThreadAttr_t External_Xbee_T_attributes = {
  .name = "External_Xbee_T",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_External_Xbee_TX */
/**
  * @brief  Function implementing the External_Xbee_T thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_External_Xbee_TX */
void External_Xbee_TX(void *argument)
{
  /* USER CODE BEGIN 5 */
